...
> **Tenant note:** when an exercise mentions Intune, Entra, or portal steps, perform those in the Microsoft 365 / Entra dev tenant and use the local VMs as your test devices. The test data comes from the standard content in that dev tenant.
