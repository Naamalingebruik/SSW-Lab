...
# VMs:  LAB-MGMT01, LAB-W11-01, LAB-W11-02
...
$btnRun.Add_Click({
    ...
    # ── Stap 5: Manual — Intune Apps portal ────────────────
    Write-LabLog "${pre}Stap 5: Manual — Intune Apps portal"
    $progress.Value = 85
...
$btnNext.Add_Click({
    ...
    else { [System.Windows.MessageBox]::Show("lab-week5-autopilot.ps1 not found.", "SSW-Lab") }
    $reader.Close()
})
