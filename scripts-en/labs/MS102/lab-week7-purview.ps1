...
$btnRun.Add_Click({
    ...
    Write-LabLog "${pre}Stap 4: Manual — eDiscovery Core zoekopdracht"
    $progress.Value = 58
    ...
    Write-LabLog "${pre}Stap 5: Manual — Compliance Manager bekijken"
    $progress.Value = 74
...
$btnNext.Add_Click({
    ...
    else { [System.Windows.MessageBox]::Show("AZ-104 lab-week1-governance.ps1 not found.", "SSW-Lab") }
    $reader.Close()
})
